...
F03_FVB <- data.frame(sort(intersectAll("n98_t97"))); F03_FVB$end <- F03_FVB$end + 1
F05_FVB <- data.frame(sort(intersectAll("n98_t96"))); F05_FVB$end <- F05_FVB$end + 1

FVB_F03 <- data.frame(sort(intersectAll("n97_t98"))); FVB_F03$end <- FVB_F03$end + 1
F05_F03 <- data.frame(sort(intersectAll("n97_t96"))); F05_F03$end <- F05_F03$end + 1

FVB_F05 <- data.frame(sort(intersectAll("n96_t98"))); FVB_F05$end <- FVB_F05$end + 1
F03_F05 <- data.frame(sort(intersectAll("n96_t97"))); F03_F05$end <- F03_F05$end + 1
...
ovg <- data.frame(sort(F03_FVBg[queryHits(findOverlaps(FVB_F03g,FVB_F05g))])); ovg$end <-  ovg$end + 1
